...
from src.forward_simulation_v5_1_4 import (  # noqa: E402
    DEMO,
    FixtureAdapter,
    STRATEGY_IDS,
    audit_integrity,
...
from src.polymarket_public_adapter_v5_1_4 import (  # noqa: E402
    AdapterError,
    PublicAdapter,
    calculate_fee,
    consume_buy_depth,
...
CONFIG = PROJECT_ROOT / "config/forward_simulation_v5_1_4.yaml"
...
def test_market_state_resolved_blocks_entry_exit_and_only_settles(tmp_path):
    ...
    resolved_market = market(active=False, closed=True, resolved=True, winningOutcome="Yes", outcomePrices=json.dumps(["1", "0"]))
...
def copy_v514_release_files(dst: Path) -> Path:
    for rel in [
        "src/forward_simulation_v5_1_4.py",
        "src/forward_reporting_v5_1_4.py",
        "src/polymarket_public_adapter_v5_1_4.py",
        "schemas/forward_simulation_v5_1_4.sql",
        "config/forward_simulation_v5_1_4.yaml",
    ]:
        target = dst / rel
        target.parent.mkdir(parents=True, exist_ok=True)
        shutil.copy2(PROJECT_ROOT / rel, target)
    for rel, body in {
        "reports/FORWARD_SIMULATION_V5_1_4_PREREGISTRATION.md": "preregistration\n",
        "reports/FORWARD_SIMULATION_V5_1_4_API_CONTRACT.md": "api contract\n",
        "reports/FORWARD_SIMULATION_V5_1_4_FEE_CONTRACT.md": "fee contract\n",
    }.items():
        target = dst / rel
        target.parent.mkdir(parents=True, exist_ok=True)
        target.write_text(body, encoding="utf-8")
    return dst / "config/forward_simulation_v5_1_4.yaml"
...
def test_deleted_frozen_file_refuses_formal_write(tmp_path):
    ...
    (tmp_path / "reports/FORWARD_SIMULATION_V5_1_4_API_CONTRACT.md").unlink()
...
def test_resolved_raw_evidence_files_hash_recomputable(tmp_path):
    ...
    raw_dir = tmp_path / "data/forward_v5_1_4/demo/resolved_market_raw"
